...
function resolveTextEditorOptions(doc, { defaults = pickWorkspaceDefaults(), onBeforeResolve, onEmptyConfig, } = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const editorconfigSettings = yield resolveCoreConfig(doc, { onBeforeResolve });
...
function resolveFile(doc) {
    ...
    return {
        fileName,
        relativePath: vscode_1.workspace.asRelativePath(fileName, true),
    };
...
function fromEditorConfig(config = {}, defaults = pickWorkspaceDefaults()) {
    ...
    return Object.assign({}, (config.indent_style === 'tab'
