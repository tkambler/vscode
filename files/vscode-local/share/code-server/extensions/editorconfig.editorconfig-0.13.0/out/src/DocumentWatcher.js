...
class DocumentWatcher {
    constructor(outputChannel = vscode_1.window.createOutputChannel('EditorConfig')) {
        ...
        this.onConfigChanged = () => {
            this.log('Detected change in configuration:', JSON.stringify(this.defaults = api_1.pickWorkspaceDefaults()));
        };
        ...
        subscriptions.push(vscode_1.workspace.onDidChangeConfiguration(this.onConfigChanged));
